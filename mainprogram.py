...
def clustering(summarytype, trainning=False, timestamp=""):
    #    ----------word2vec train---------
...
#    jieba.set_dictionary(_PATH+"text segmentation/dict.txt.big")
    ...
    mixver, trrate, istrainning = False, 0.7, False
